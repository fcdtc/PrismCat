                    ...
                    <div className={cn(sectionCardClassName, "space-y-4")}>
                        ...
                        <div className="space-y-2">
                            <SectionHeader
                                ...
                                icon={ListTree}
                                extra={<span className="text-xs font-bold text-muted-foreground">{Object.keys(log.request_headers ?? {}).length} KEYS</span>}
                            />
                    ...
                    <div className={cn(sectionCardClassName, "space-y-4")}>
                        ...
                        <div className="space-y-2">
                            <SectionHeader
                                ...
                                icon={ListTree}
                                extra={<span className="text-xs font-bold text-muted-foreground">{Object.keys(log.response_headers ?? {}).length} KEYS</span>}
                            />
